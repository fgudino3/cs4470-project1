...
{    
    ...
    public Entity1()
    {
		...
		System.arraycopy(distanceTable[1], 0, minCost, 0, NetworkSimulator.NUMENTITIES);


		routePacket(1 , 0 , minCost);
		routePacket(1 , 2 , minCost);
    ...
    public void update(Packet p)
    {
		...
		//Preforming Bellman Ford Algorithm, Cost | Preform Path Cost
